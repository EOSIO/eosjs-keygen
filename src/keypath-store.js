...
/**
  ...
  This keypathStore does not query the blockchain or any external services.
  Removing keys here does not affect the blockchain.
*/
module.exports = KeypathStore

function KeypathStore(accountName) {
  ...
  */
  function remove(paths, keepPublicKeys = false) {
    // console.log('keypathStore ==> remove paths', paths)
...
/** Erase all traces of this KeypathStore (for all users).  */
KeypathStore.wipeAll = function() {
